...
### 点击播放视频 ▼
[![Watch the video](https://i.sstatic.net/Vp2cE.png)](https://www.bilibili.com/video/BV1T48XecE9G?p=175)


# 绪论
## 1.1 研究背景
当前社会各行业领域竞争压力非常大，随着当前时代的信息化，科学化发展，让社会各行业领域都争相使用新的信息技术，对行业内的各种相关数据进行科学化，规范化管理。这样的大环境让那些止步不前，不接受信息改革带来的信息技术的企业随时面临被淘汰，被取代的风险。所以当今，各个行业领域，不管是传统的教育行业，餐饮行业，还是旅游行业，医疗行业等领域都将使用新的信息技术进行信息革命，改变传统的纸质化，需要人手工处理工作事务的办公环境。软件信息技术能够覆盖社会各行业领域是时代的发展要求，各种数据以及文件真正实现电子化是信息社会发展的不可逆转的必然趋势。本医用物理学实验考核系统也是紧跟科学技术的发展，运用当今一流的软件技术实现软件系统的开发，让医生管理信息完全通过管理系统实现科学化，规范化，程序化管理。从而帮助信息管理者节省事务处理的时间，降低数据处理的错误率，对于基础数据的管理水平可以起到促进作用，也从一定程度上对随意的业务管理工作进行了避免，同时，医用物理学实验考核系统的数据库里面存储的各种动态信息，也为上层管理人员作出重大决策提供了大量的事实依据。总之，医用物理学实验考核系统是一款可以真正提升管理者的办公效率的软件系统。
## 1.2 目的和意义
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|20|news\_name|String|名称|是|
|21|news\_photo|String|图片|是|
|22|insert\_time|Date|时间|是|
|23|news\_content|String|详情|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|25|shiyanpaike\_id|Integer|课程名称|是|
|26|yonghu\_id|Integer|实验学生|是|
|27|chengji\_pingfen|Integer|评分|是|
|28|chengji\_content|String|实验数据|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|30|shiyanpaike\_name|String|课程名称|是|
|31|shiyanpaike\_types|Integer|课程类型|是|
|32|shiyanpaike\_time|Date|上课时间|是|
|33|jiaoshi\_id|Integer|上课教师|是|
|34|banji\_types|Integer|上课班级|是|
|35|shiyanpaike\_fenzu|String|分组|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|37|shiyanpaike\_id|Integer|课程名称|是|
|38|shiyanshuju\_yuanli|String|原理与方法|是|
|39|shiyanshuju\_yiqi|String|使用仪器|是|
|40|shiyanshuju\_buzou|String|实验步骤|是|
|41|shiyanshuju\_content|String|实验数据处理|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|43|shiyanpaike\_id|Integer|预习课程|是|
|44|shiyanyuxi\_mudi|String|实验目的|是|
|45|shiyanyuxi\_yiqiu|String|实验要求|是|
|46|shiyanyuxi\_shuxi|String|熟悉仪器|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|48|yonghu\_name|String|学生姓名|是|
|49|sex\_types|Integer|性别|是|
|50|yonghu\_id\_number|String|身份证号|是|
|51|yonghu\_phone|String|手机号|是|
|52|yonghu\_photo|String|照片|是|
|53|banji\_types|Integer|班级|是|
|54|create\_time|Date|创建时间|是|
表4.10用户表表
...
图5.2 教师信息管理页面
### 5.3实验排课管理
如图5.3显示的就是实验排课管理页面，此页面提供给管理员的功能有：根据实验排课进行条件查询，还可以对实验排课进行新增、修改、查询操作等等。

![](/md/blog.012.png)

图5.3 实验排课管理页面
### 5.1实验预习管理
如图5.4显示的就是实验预习管理页面，此页面提供给管理员的功能有：根据实验预习进行新增、修改、查询操作等等。
